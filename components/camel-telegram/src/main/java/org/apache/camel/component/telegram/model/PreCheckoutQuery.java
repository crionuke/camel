...
public class PreCheckoutQuery implements Serializable {
    ...
    public PreCheckoutQuery(String id, User from, String currency, Integer totalAmount, Integer invoicePayload,
                            Integer shippingOptionId, OrderInfo orderInfo) {
        this.id = id;
        this.from = from;
    ...
    public Integer getInvoicePayload() {
        return invoicePayload;
    }

    public void setInvoicePayload(Integer invoicePayload) {
        this.invoicePayload = invoicePayload;
    }
